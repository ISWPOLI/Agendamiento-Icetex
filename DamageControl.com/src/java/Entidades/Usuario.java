...
@NamedQueries({
    ...
    @NamedQuery(name = "Usuario.findByUsDocumento", query = "SELECT u FROM Usuario u WHERE u.usDocumento = :usDocumento"),
...
public class Usuario implements Serializable {
    ...
    @Basic(optional = false)
    @NotNull
    @Column(name = "US_DOCUMENTO")
    private long usDocumento;
    @Size(max = 20)
    ...
    public Usuario(String nombre, String apellido, long usDocumento, String usuario, String contraseña) {
        this.nombre = nombre;
    ...
    public long getUsDocumento() {
        return usDocumento;
    }

    public void setUsDocumento(long usDocumento) {
        this.usDocumento = usDocumento;
    }
    ...
    public String toString() {
        return "Entidades.Usuario[ nombre=" + nombre + " ]";
    }
